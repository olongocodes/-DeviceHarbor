...
class ProductResource(Resource):
    ...
    def get(self, product_id=None):
        if product_id is None:
            ...
            return [{"id": product.id, "name": product.name, "quantity": product.quantity, "category": product.category, "image_url": product.image_url,"price": product.price} for product in products]
    ...
    def post(self):
        try:
            ...
            data = request.get_json()
            new_product = Product(name=data['name'], quantity=data['quantity'], category=data['category'], image_url=data['image_url'], price=data['price'])
